...
public class StringCache {
	...
	public static final String AMPER_ENCODED = "&amp;";
	...
	public static final String HTML_STYLE_CLASS="class";
	
	public static final String HTML_DIV=StringHtml.DIV;
	
	public static final String REGEX_NUMBER_MATCHES="[0-9]+";
	
	public static final String REGEX_DATE_MATCHES="\\d\\d/\\d\\d/\\d\\d\\d\\d";
	
	public static final String REGEX_LEFT_TRIM="^\\s+";
	
	public static final String REGEX_RIGHT_TRIM="\\s+$";
	...
	public static final String ALL_UPPERCASE_LETTERS="ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	 ...
	 public static final String INVALID_NULL_PARAM = "Object/Value cannot be null";
